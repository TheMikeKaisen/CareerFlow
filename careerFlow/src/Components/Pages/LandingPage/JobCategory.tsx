    ...
    <div className="flex flex-col gap-3 mt-20 pb-5 text-center">
      ...
      >
        ...
        {jobCategory.map((category, index) => (
          <Carousel.Slide>
            <div key={index} className="flex flex-col gap-2 items-center w-64 border border-bright-sun-400 p-5 rounded-xl hover:cursor-pointer hover:shadow-[0_0_5px_2px_black] !shadow-bright-sun-300 my-5 transition duration-150 ease-in-out">
